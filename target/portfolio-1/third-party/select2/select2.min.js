    ...
    var b = function() {
            ...
            return function() {
                                ...
                                for (c = a.split("/"), k = c.length; k > 0; k -= 1) {
                                    if (d = c.slice(0, k).join("/"), o)
                                        for (l = o.length; l > 0; l -= 1)
                                            if ((e = p[o.slice(0, l).join("/")]) && (e = e[d])) { f = e, h = k; break } if (f) break;
                                    !i && q && q[d] && (i = q[d], j = k)
                ...
                return d.prototype.render = function(b) {
                    ...
                    else { a = .75 * (this.$search.val().length + 1) + "em" } this.$search.css("width", a)
                }, d
                ...
                return D.prototype.apply = function(l) {
                    ...
                    if (a.isArray(l.language)) {
                        ...
                        for (var K = l.language, L = 0; L < K.length; L++) {
                            var M = K[L],
                                N = {};
                            try { N = k.loadPath(M) } catch (a) { try { M = this.defaults.amdLanguageBase + M, N = k.loadPath(M) } catch (a) { l.debug && window.console && console.warn && console.warn('Select2: The language file for "' + M + '" could not be automatically loaded. A fallback will be used instead.'); continue } } J.extend(N)
                        }
                        l.translations = J
                    } else {
